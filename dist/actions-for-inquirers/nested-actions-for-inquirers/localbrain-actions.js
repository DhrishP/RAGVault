...
export const LocalBrainActions = async (action, username, users, session) => {
    switch (action) {
        case "Add Data using Terminal":
            try {
                ...
                await handleAuthenticatedAction(newActionSucess, username, session, users);
                break;
            }
            catch (error) {
        ...
        case "Add Data using PDF/DOCX":
            ...
            try {
                ...
                if (fileExtension === "pdf") {
                    ...
                    console.log("Unsupported file type. Please provide a .pdf or .docx file.");
                    return;
                }
            }
            catch (error) {
